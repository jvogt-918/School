...
C.  Use the `vif` function within the **car** package to examine the VIFs.  Are there any concerns for this particular study's goals and research question?  What if there were really high VIFs among Education, Nonwhite, and NOX?  Would that change your answer?
...
```{r}
setwd("~/Desktop/CourseDev/Unit 1/HW")
...
B. (Stretch question)  Suppose I wanted to formally test if the slope for the pike species is different from the slope of the smelt.  What contrast could we construct to formally test this?  Hint: Determine the beta's that are involved in each one of the indviduals slopes and subtract one from the other.
```{r}
